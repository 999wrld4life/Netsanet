  ...
  return (
    <div className="glass-panel p-8 rounded-xl border-eth-yellow border-t-4 max-w-2xl mx-auto text-center shadow-xl">
      ...
      <p className="text-dark-muted mb-8 max-w-md mx-auto">
        Scan the patient's QR code to connect their record to this clinic
        session, or paste their Ethereum address manually.
      </p>

      {/* Simulated Scanner Area */}
      <div className="bg-black dark:bg-dark-surface aspect-video rounded-xl border dark:border-dark-border border-slate-200 flex flex-col items-center justify-center mb-8 relative overflow-hidden">
        ...
        <p className="text-secondary text-sm z-10">
          Camera feed disabled for demo
        </p>
        <p className="text-xs text-dark-muted mt-2 z-10">
